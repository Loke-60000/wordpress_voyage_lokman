...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230104_voyage_lokman_b64d420704c004622259_20230104133009_archive.zip';
        const ARCHIVE_SIZE       = '54981304';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b64d420-04133009';
        const SECONDARY_PACKAGE_HASH = '53e0a3e-04133009';
        const VERSION            = '1.5.1';
